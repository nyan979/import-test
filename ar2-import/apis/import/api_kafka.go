...
func (a *Application) FetchMessage(ctx context.Context, messages chan<- kafka.Message) error {
...
func (a *Application) WriteMessages(ctx context.Context, messages <-chan kafka.Message, messagesCommit chan<- kafka.Message) error {
...
func (a *Application) CommitMessages(ctx context.Context, messagesCommit <-chan kafka.Message) error {
	for {
		select {
		case <-ctx.Done():
